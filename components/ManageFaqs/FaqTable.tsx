...
const FaqTable = () => {
  ...
  return (
    <section className="dashboard-container min-h-svh">
      ...
      <h2 className="text-2xl font-bold mb-1 bg-text">Manage FAQs</h2>
      <span className="text-gray-500">Overview of faqs on TalentNest</span>
      <div className="flex w-full text-[#010D3E] md:text-lg font-bold mt-16 border-b-[3px] border-[#010D3E]">
        <span
          ...
          style={{ width: "300px", justifyContent: "flex-start" }}
        >
